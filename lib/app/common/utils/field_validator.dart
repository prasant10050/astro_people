...
class MaxLengthValidator extends TextFieldValidator {
  ...
  MaxLengthValidator(this.max, {required String errorText, bool? required})
...
class MinLengthValidator extends TextFieldValidator {
  ...
  MinLengthValidator(this.min, {required String errorText, bool? required})
      : super(errorText, required: required);
...
class EmailValidator extends TextFieldValidator {
  ...
  EmailValidator({required String errorText, bool? required})
      : super(errorText, required: required);
...
class PatternValidator extends TextFieldValidator {
  ...
  PatternValidator(this.pattern,
      {required String errorText, this.caseSensitive = true, bool? required})
      : super(errorText, required: required);
...
class DateValidator extends TextFieldValidator {
  ...
  DateValidator(this.format, {required String errorText, bool? required})
      : super(errorText, required: required);
